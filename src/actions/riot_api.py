...
from src.resources.entity import PlayerDataRes, LeaderboardEntry, Competitor_v
...
def get_rank_data(competitor: Competitor_v) -> LeaderboardEntry | None:
...
def get_ranks() -> list[LeaderboardEntry]:
    ...
    valid_competitors: list[Competitor_v] = get_competitors_by_status()
